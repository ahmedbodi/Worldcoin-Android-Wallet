...
package de.schildbach.wallet.worldcoin.integration.android;
...
public final class WorldcoinIntegration
{
	...
	/**
	 * Request any amount of Worldcoins (probably a donation) from user, without feedback from the app.
	 * 
	 * @param context
	 *            Android context
	 * @param address
	...
	/**
	 * Request specific amount of Worldcoins from user, without feedback from the app.
	 *
	 * @param context
	 *            Android context
	 * @param address
	...
	/**
	 * Request any amount of Worldcoins (probably a donation) from user, with feedback from the app. Result intent can be
	 ...
	 * 
	 * Warning: A success indication is no guarantee! To be on the safe side, you must drive your own Worldcoin
	...
	/**
	 * Request specific amount of Worldcoins from user, with feedback from the app. Result intent can be received by
	...
	/**
	 * Put transaction hash into result intent. Meant for usage by Worldcoin wallet applications.
	 * 
	 * @param result
	 *            result intent
	 * @param txHash
	...
	/**
	 * Get transaction hash from result intent. Meant for usage by applications initiating a Worldcoin payment.
	 * 
	 * You can use this hash to request the transaction from the Worldcoin network, in order to validate. For this, you
	 * need your own Worldcoin infrastructure though. There is no guarantee that the transaction has ever been broadcasted
	...
	private static void redirectToDownload(final Context context)
	{
		...
		final Intent binaryIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://github.com/ahmedbodi/worldcoin-wallet"));
