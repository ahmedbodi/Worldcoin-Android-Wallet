...
import de.schildbach.wallet.worldcoin.AddressBookProvider;
import de.schildbach.wallet.worldcoin.Constants;
import de.schildbach.wallet.worldcoin.WalletApplication;
import de.schildbach.wallet.worldcoin.integration.android.WorldcoinIntegration;
import de.schildbach.wallet.worldcoin.service.BlockchainService;
import de.schildbach.wallet.worldcoin.service.BlockchainServiceImpl;
	...
	public void onActivityResult(final int requestCode, final int resultCode, final Intent intent)
	{
		if (requestCode == REQUEST_CODE_SCAN && resultCode == Activity.RESULT_OK)
		{
			...
			else
			{
				try
				{
					final WorldcoinURI worldcoinUri = new WorldcoinURI(null, contents);
					final Address address = worldcoinUri.getAddress();
					final String addressLabel = worldcoinUri.getLabel();
					update(address != null ? address.toString() : null, addressLabel, worldcoinUri.getAmount());
				}
	...
	private void handleGo()
	{
		...
		backgroundHandler.post(new Runnable()
		{
			public void run()
			{
                ...
                Log.d("worldcoin", "Transaction size is " + transaction.getOutputs().size());
