...
import com.google.worldcoin.core.FullPrunedBlockChain;
...
public class BlockImporter {
    public static void main(String[] args) throws Exception {
        ...
        if (System.getProperty("os.name").toLowerCase().indexOf("win") >= 0) {
            defaultDataDir = System.getenv("APPDATA") + "\\.worldcoin/";
        } else {
            defaultDataDir = System.getProperty("user.home") + "/.worldcoin/";
        }
