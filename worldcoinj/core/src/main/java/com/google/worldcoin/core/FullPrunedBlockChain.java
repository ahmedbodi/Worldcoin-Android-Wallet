 ...
 * Worldcoin system, with the downside being a larg cost in system resources. Fully verifying means all unspent transaction
            ...
            for (Transaction tx : block.transactions) {
                ...
                if (!isCoinBase) {
                    ...
                    for (int index = 0; index < tx.getInputs().size(); index++) {
                        ...
                        // In my tests, total time spent in com.google.worldcoin.core when
                        ...
                        try {
                            txCache = new Transaction(params, tx.unsafeWorldcoinSerialize());
