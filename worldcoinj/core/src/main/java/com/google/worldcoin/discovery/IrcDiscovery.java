...
package com.google.worldcoin.discovery;
...
public class IrcDiscovery implements PeerDiscovery {
     ...
     * disconnecting.
     *
     * @param channel The IRC channel to join, either "#worldcoin00" or "#worldcoinTEST3" for the production and test networks
     *                respectively.
     */
    ...
    public InetSocketAddress[] getPeers(long timeoutValue, TimeUnit timeoutUnit) throws PeerDiscoveryException {
        ...
        try {
            ...
            // worldcoinj but not match the standard nick format, so full peers don't try and connect to us.
    ...
    static ArrayList<InetSocketAddress> parseUserList(String[] userNames) throws UnknownHostException {
        ...
        for (String user : userNames) {
            // All Worldcoin peers start their nicknames with a 'u' character.
            ...
            try {
                ...
                // so simply beginning with "u" does not imply this is a valid Worldcoin encoded address.
                //
