...
import com.google.worldcoin.core.Peer.PeerHandler;
...
public class PeerGroup extends AbstractIdleService {
    ...
    // pipeline with the worldcoin serializer ({@code TCPNetworkConnection}) downstream
     ...
     * <a href="https://en.worldcoin.it/wiki/BIP_0014">BIP 14</a>.
     *
     ...
     * someone and want to know that it's valid. It's a bit of a weird hack because the current version of the worldcoin
