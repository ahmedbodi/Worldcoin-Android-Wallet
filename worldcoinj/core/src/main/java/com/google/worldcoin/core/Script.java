 ...
 *
 * <p>Worldcoin transactions don't specify what they do directly. Instead <a href="https://en.bitcoin.it/wiki/Script">a
...
public class Script {
    ...
    public byte[] getPubKeyHash() throws ScriptException {
        ...
        // Otherwise, the third element is the hash of the public key, ie the worldcoin address.
     ...
     *
     * <p>worldcoinj does not support creation of P2SH transactions today. The goal of P2SH is to allow short addresses
