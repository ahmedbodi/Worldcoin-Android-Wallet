...
/**
 * <p>A block is a group of transactions, and is one of the fundamental data structures of the Worldcoin system.
 ...
 * <a href="http://www.worldcoin.org/worldcoin.pdf">the Worldcoin technical paper</a> for
...
public class Block extends Message {
     ...
     * upgrade everyone to change this, so Worldcoin can continue to grow. For now it exists as an anti-DoS measure to
    ...
    /** Constructs a block object from the Worldcoin wire format. */
    ...
    /**
     * <p>A utility method that calculates how much new Worldcoin would be created by the block at the given height.
     * The inflation of Worldcoin is predictable and drops roughly every 4 years (210,000 blocks). At the dawn of
    ...
    /** Returns the version of the block data structure as defined by the Worldcoin protocol. */
     ...
     * the difficulty value reported by the Worldcoin "getdifficulty" RPC that you may see on various block explorers.
