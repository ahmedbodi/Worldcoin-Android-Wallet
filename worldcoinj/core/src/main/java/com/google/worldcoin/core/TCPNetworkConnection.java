...
/**
 * <p>A {@code TCPNetworkConnection} is used for connecting to a Worldcoin node over the standard TCP/IP protocol.<p>
 *
...
public class TCPNetworkConnection implements NetworkConnection {
    ...
    private WorldcoinSerializer serializer = null;
    ...
    public TCPNetworkConnection(NetworkParameters params, VersionMessage ver) {
        ...
        this.serializer = new WorldcoinSerializer(this.params);
    ...
    private void onVersionMessage(Message m) throws IOException, ProtocolException {
        ...
        // worldcoinj is a client mode implementation. That means there's not much point in us talking to other client
    ...
    public class NetworkHandler extends ReplayingDecoder<VoidEnum> implements ChannelDownstreamHandler {
        ...
        // Attempt to decode a Worldcoin message passing upstream in the channel.
        //
        ...
        /** Serialize outgoing Worldcoin messages passing downstream in the channel. */
    ...
    /** Returns the Netty Pipeline stage handling Worldcoin serialization for this connection. */
