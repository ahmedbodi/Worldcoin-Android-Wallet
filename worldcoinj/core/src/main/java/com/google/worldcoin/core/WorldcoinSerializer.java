...
/**
 * <p>Methods to serialize and de-serialize messages to the Worldcoin network format as defined in
 ...
 * <li>Message.worldcoinSerializeToStream() needs to be properly subclassed</li>
 * </ul>
 */
public class WorldcoinSerializer {
    private static final Logger log = LoggerFactory.getLogger(WorldcoinSerializer.class);
    ...
    /**
     * Constructs a WorldcoinSerializer with the given behavior.
     *
     * @param params           networkParams used to create Messages instances and termining packetMagic
     */
    public WorldcoinSerializer(NetworkParameters params) {
     ...
     */
    public WorldcoinSerializer(NetworkParameters params, boolean parseLazy, boolean parseRetain) {
        this.params = params;
    ...
    public void serialize(Message message, OutputStream out) throws IOException {
        ...
        if (name == null) {
            throw new Error("WorldcoinSerializer doesn't currently know how to serialize " + message.getClass());
        }
        ...
        byte[] payload = message.worldcoinSerialize();
    ...
    public Message deserialize(InputStream in) throws ProtocolException, IOException {
        // A Worldcoin protocol message has the following format.
        //
        ...
        WorldcoinPacketHeader header = new WorldcoinPacketHeader(in);
     ...
     */
    public WorldcoinPacketHeader deserializeHeader(InputStream in) throws ProtocolException, IOException {
        return new WorldcoinPacketHeader(in);
    }

    /**
     * Deserialize payload only.  You must provide a header, typically obtained by calling
     * {@link WorldcoinSerializer#deserializeHeader}.
     */
    public Message deserializePayload(WorldcoinPacketHeader header, InputStream in) throws ProtocolException, IOException {
        int readCursor = 0;
    ...
    public static class WorldcoinPacketHeader {
        public final byte[] header;
        public final String command;
        public final int size;
        public final byte[] checksum;

        public WorldcoinPacketHeader(InputStream in) throws ProtocolException, IOException {
