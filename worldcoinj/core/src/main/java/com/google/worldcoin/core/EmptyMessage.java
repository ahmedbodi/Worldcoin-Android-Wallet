 ...
 * Currently this includes getaddr, ping, verack as well as the special worldcoinj class UnknownMessage
 *
 * @author git
 */
public abstract class EmptyMessage extends Message {
    ...
    @Override
    final protected void worldcoinSerializeToStream(OutputStream stream) throws IOException {
    }
    ...
    /* (non-Javadoc)
      * @see Message#worldcoinSerialize()
      */
    @Override
