 ...
 * to the network, in case IRC and DNS fail. The list comes from the Worldcoin C++ source code.
 */
public class SeedPeers implements PeerDiscovery {
    ...
    /**
     * Returns an array containing all the Worldcoin nodes within the list.
     */
