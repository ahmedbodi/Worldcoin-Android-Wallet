...
public class VersionMessage extends Message {
    ...
    public static final String LIBRARY_SUBVER = "/WorldcoinJ:" + LITECOINJ_VERSION + "/";
    ...
    @Override
    public void worldcoinSerializeToStream(OutputStream buf) throws IOException {
        ...
        try {
            // My address.
            myAddr.worldcoinSerialize(buf);
            // Their address.
            theirAddr.worldcoinSerialize(buf);
        } catch (UnknownHostException e) {
     ...
     * name:version pairs separated by slashes in the form of a path. For example a typical subVer field for WorldcoinJ
     * users might look like "/WorldcoinJ:0.4-SNAPSHOT/MultiBit:1.2/" where libraries come further to the left.<p>
     *
     ...
     * set of "/WorldcoinJ:1.0/MultiBit:1.0(Windows)/. Therefore the / ( and ) characters are reserved in all these
