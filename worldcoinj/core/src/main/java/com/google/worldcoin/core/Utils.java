...
/**
 * A collection of various utility methods that are helpful for working with the Worldcoin protocol.
 * To enable debug logging from the library, run with -Dworldcoinj.logging=true on your command line.
 */
public class Utils {
    ...
    /** The string that prefixes all text messages signed using Worldcoin keys. */
    public static final String LITECOIN_SIGNED_MESSAGE_HEADER = "Worldcoin Signed Message:\n";

    // TODO: Replace this nanocoins business with something better.

    /**
     * How many "nanocoins" there are in a Worldcoin.
     * <p/>
     * A nanocoin is the smallest unit that can be transferred using Worldcoin.
    ...
    /**
     * How many "nanocoins" there are in 0.01 Worldcoins.
     * <p/>
     ...
     * standard procedure in Worldcoin. The resulting hash is in big endian form.
     */
     ...
     */
    public static String worldcoinValueToFriendlyString(BigInteger value) {
     ...
     */
    public static String worldcoinValueToPlainString(BigInteger value) {
        if (value == null) {
     ...
     *
     * <tt><p>[24] "Worldcoin Signed Message:\n" [message.length as a varint] message</p></tt>
     */
